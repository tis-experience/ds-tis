...
### Corrigido
- **Arrow e runtime do Popover no Storybook.** A Arrow deixa de ser recortada pelo `overflow` do panel e permanece ancorada ao trigger nas quatro posições; os exemplos da aba Documentação passam a ser inicializados e interativos, com cobertura de browser para visibilidade da Arrow e abertura dentro de `#storybook-docs`.
