...
### Corrigido
- **Logo da documentação carrega corretamente em todas as rotas.** Topbar passa a usar o logotipo completo `docs/assets/logo-tis.svg` no padrão `TIS | Design System`; paths de asset em páginas geradas, ADRs e templates foram corrigidos para resolver a imagem a partir do HTML real.
