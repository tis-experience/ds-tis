...
const preview: Preview = {
  ...
  parameters: {
    ...
    options: {
      storySort: {
        order: ["Introdução", "Componentes", ["Accordion", "Alert", "Badge", "Button", "Checkbox", "Combobox", "Input Text", "Menu", "Modal", "Popover", "Radio", "Select", "Tabs", "Textarea", "Toast", "Toggle", "Tooltip"]],
      },
    },
  },
};
