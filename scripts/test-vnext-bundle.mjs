...
const arkBadgeModule = path.join(ROOT, 'packages/react/src/ark/badge.jsx');
...
const entries = {
  'adapter-ark-badge': {
    group: 'Ark/Zag incremental', budget: 3 * 1024,
    source: `import { Badge } from ${JSON.stringify(arkBadgeModule)}; export { Badge };`,
  },
  'adapter-ark-alert': {
