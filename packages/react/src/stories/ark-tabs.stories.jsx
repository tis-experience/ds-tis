...
export default {
  id: 'ark-tabs',
  title: 'Outputs/Ark + Zag/Tabs',
  component: Tabs,
  tags: ['autodocs'],
  parameters: {
    docs: {
      description: {
        component: 'Adapter Tabs independente. Ark UI fornece as parts React, Zag mantém seleção, roving tabindex e teclado, e o DS TIS preserva visual e tokens.',
      },
    },
  },
