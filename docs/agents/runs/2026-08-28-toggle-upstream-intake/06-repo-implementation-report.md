...
- Status: Passed
- Componente/padrão: Toggle
- Run: `2026-08-28-toggle-upstream-intake`
- Agent: Repo Component Agent
- Data: 2026-08-28

## Entrada

- Figma aprovado: unchanged with evidence; página `138:2`, root `139:2`
- Token sync: não aplicável; os 39 tokens Component existentes foram preservados
- Plano repo: `05-repo-sync-plan.md`

## Arquivos alterados

- Web: `css/components/toggle.css`, tokens e API pública permaneceram íntegros; `docs/toggle.html` recebeu somente landmarks editoriais aditivos
- Source Ark: adapter `packages/react/src/ark/toggle.jsx`, CSS isolado, export `./ark/toggle` e stories próprias
- Source React: recipe existente `registry/tis/switch.tsx` preservada e integrada à documentação unificada
...
- CHANGELOG: saída Toggle vNext registrada em `[Não publicado]`

## Decisões de implementação

- Ark UI/Zag e Base UI mantêm source, dependências, instalação e stories independentes; não há import cruzado.
- O adapter Ark preserva o hidden input, acrescenta `role="switch"` e mapeia os estados Zag para o contrato visual tokenizado do Toggle TIS.
- On/off, Space, disabled, tamanhos, foco, label estável e submissão de formulário são exercitados em browser real.
...
- bundle Ark: primitive 8,69 KiB gzip; adapter 9,37; preview 20,15 — todos abaixo do orçamento
- bundle Base UI: preview 23,82 KiB gzip — abaixo do orçamento de 30 KiB
...
- Pages: 917 arquivos, 199 páginas HTML e links locais íntegros
