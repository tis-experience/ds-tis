...
- Run ID: 2026-08-28-toggle-upstream-intake
- Title: Toggle
...
Completar Toggle nas três saídas sem alterar Web/Figma.

## Owner decision log

- 2026-08-28: Owner autorizou execução contínua componente a componente, preservando Figma e Web.
- 2026-08-28: Ark/Zag implementado e as três saídas validadas; release não autorizado.
