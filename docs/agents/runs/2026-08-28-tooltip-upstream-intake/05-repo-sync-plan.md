...
- Tokens CSS-only: `semantic.z.tooltip`, sem mudança
- Component tokens: `tokens/component/tooltip.json`, sem mudança
- Registry: adicionar receita `tooltip`
...
- API/LLM: registry shadcn e metadados vNext; API estável não muda
- CHANGELOG: registrar saída Tooltip vNext
