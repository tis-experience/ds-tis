...
- Run ID: 2026-08-28-tabs-upstream-intake
- Title: Tabs
...
Entregar Tabs equivalente nas três saídas sem alterar o contrato Web/Figma

## Owner decision log

- 2026-08-28: Run created.
- 2026-08-28: Owner approved continuous local execution while preserving Figma and Web.
- 2026-08-28: Web, Ark/Zag and React/shadcn/Base UI validated locally.
- 2026-08-28: Mobile review found and corrected multi-line labels in Ark and React.
...
Use esta run: docs/agents/runs/2026-08-28-tabs-upstream-intake
