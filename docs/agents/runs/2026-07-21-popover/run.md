...
Planejar e executar Popover no DS Core.

## Owner decision log

- 2026-07-21: Run created.
- 2026-07-21: Owner rejeitou draft visual/documental (Inter/hex soltos; fora do padrão DS).
- 2026-07-21: Rebuild: dump Tooltip/Modal/Alert → matriz documental → página clonada de Tooltip `194:39` com binds; set `10332:504` arrow VECTOR; vars `10319:2–21` mantidas. Gate figma-build blocked até OK visual.
...
Use esta run: docs/agents/runs/2026-07-21-popover
