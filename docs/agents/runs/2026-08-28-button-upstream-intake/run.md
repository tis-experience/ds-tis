...
- Run ID: 2026-08-28-button-upstream-intake
- Title: Button
...
Completar Button nas três saídas sem alterar Web/Figma.

## Owner decision log

- 2026-08-28: Owner autorizou execução contínua componente a componente, preservando Figma e Web.
- 2026-08-28: Ark Factory implementado e as três saídas validadas; release não autorizado.

## Out of scope

- Commit, push, PR e release.
- Escrita no Figma, tokens ou core Web.
